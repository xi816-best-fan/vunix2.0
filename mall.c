...
int main() {
  ...
  compile("gcc -pedantic -Wextra -Wall -o vmvuniz-vunix kernel/main.c kernel/init_kernel.c kernel/panic.c kernel/shell.c kernel/vfs.c kernel/rescue.c kernel/exec.c", "kernel");
